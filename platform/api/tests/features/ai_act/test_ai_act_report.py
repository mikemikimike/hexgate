...
# ---------------------------------------------------------------------------
# Stand-in for the one interface another PR still owns (see ai_act/upstream.py)
# ---------------------------------------------------------------------------
...
# The matrix is no longer stubbed: hexgate.security.matrix is on main, so the
# golden is built from a real PolicySet through the real tabulator. A stub here
# would only pin this slice against a shape of its own invention.
GOLDEN_POLICY_YAML = """
version: 1
roles:
  default:
